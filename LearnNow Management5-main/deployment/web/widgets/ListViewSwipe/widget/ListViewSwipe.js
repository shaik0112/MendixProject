...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! hammerjs */ "./node_modules/hammerjs/hammer.js"), __webpack_require__(/*! dojo/dom-style */ "dojo/dom-style"), __webpack_require__(/*! ./Utils */ "./src/Utils.ts"), __webpack_require__(/*! ./polyfill */ "./src/polyfill.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, Hammer, domStyle, Utils_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var HammerSwipe = (function () {
        function HammerSwipe(container, options) {
            var _this = this;
            this.isSwiped = false;
            this.isScrolling = false;
            this.thresholdCompensation = 0;
            this.delayRemoveItem = 400;
            this.thresholdScroll = 60;
            this.defaultThresholdAcceptSwipe = 30;
            this.thresholdMove = 25;
            this.thresholdVelocity = 1.2;
            this.buttonClasses = ["mx-button", "mx-link", "clickable"];
            ...
            var direction = options.swipeDirection === "right" ? Hammer.DIRECTION_RIGHT
            ...
            this.hammer.on("panstart", function (event) { return _this.onPanStart(event); });
            this.hammer.on("panmove", function (event) { return _this.onPanMove(event); });
            this.hammer.on("panend pancancel", function (event) { return _this.onPanEnd(event); });
        }
        HammerSwipe.prototype.destroy = function () {
            this.hammer.destroy();
        };
        HammerSwipe.prototype.setupElements = function (options) {
            var setForeground = this.container.querySelector("." + this.options.classPrefix + "-foreground");
            if (setForeground) {
                this.foreElement = setForeground;
            }
            else {
                this.foreElement = this.container.firstChild.firstChild;
                Utils_1.Utils.addClass(this.foreElement, this.options.classPrefix + "-foreground");
            }
            this.backElement = {
        ...
        HammerSwipe.prototype.checkButtons = function (direction) {
            var backElement = this.backElement[direction];
            if (backElement && this.options.afterSwipeAction[direction] === "button") {
                var buttons = backElement.querySelectorAll("." + this.buttonClasses.join(", ."));
                if (buttons.length === 0) {
        ...
        HammerSwipe.prototype.findElement = function (name, displayName) {
            var element = name ? this.container.querySelector(".mx-name-" + name) : undefined;
            if (name && !element) {
                throw new Error("LVS no '" + displayName + "' found named " + name + ". It should be placed inside the list view");
            }
            return element;
        };
        HammerSwipe.prototype.setElementClasses = function () {
            var prefix = this.options.classPrefix;
            Utils_1.Utils.addClass(this.backElement.left, prefix + "-background");
            Utils_1.Utils.addClass(this.backElement.right, prefix + "-background");
            if (this.backElement.left === this.backElement.right) {
                Utils_1.Utils.addClass(this.backElement.left, prefix + "-background-shared");
            }
            else {
                Utils_1.Utils.addClass(this.backElement.left, prefix + "-background-left");
                Utils_1.Utils.addClass(this.backElement.right, prefix + "-background-right");
            }
            Utils_1.Utils.addClass(this.afterElement.left, prefix + "-background-after");
            Utils_1.Utils.addClass(this.afterElement.right, prefix + "-background-after");
            if (this.afterElement.left === this.afterElement.right) {
                Utils_1.Utils.addClass(this.afterElement.left, prefix + "-background-after-shared");
            }
            else {
                Utils_1.Utils.addClass(this.afterElement.left, prefix + "-background-after-left");
                Utils_1.Utils.addClass(this.afterElement.right, prefix + "-background-after-right");
            }
        };
        HammerSwipe.prototype.shouldCancel = function (event) {
            var prefix = this.options.classPrefix;
        ...
        HammerSwipe.prototype.onPanStart = function (event) {
        ...
        HammerSwipe.prototype.onPanMove = function (event) {
            if (this.panCanceled)
                return;
            if (this.isSwiped)
                return;
            if (this.isScrolling)
                return;
            var isScrolling = Math.abs(event.deltaY) > this.thresholdScroll;
            if (isScrolling) {
                this.isScrolling = true;
                this.show(0, true);
                return;
            }
            var percentage = (100 / this.containerSize) * (event.deltaX - this.thresholdCompensation);
        ...
        HammerSwipe.prototype.onPanEnd = function (event) {
            if (this.panCanceled)
                return;
            if (this.isScrolling)
                return;
            ...
            var percentage = (100 / this.containerSize) * (event.deltaX - this.thresholdCompensation);
            var direction = percentage < 0 ? "left" : "right";
            if (this.options.swipeDirection === "right" && percentage < 0) {
                percentage = 0;
            }
            if (this.options.swipeDirection === "left" && percentage > 0) {
        ...
        HammerSwipe.prototype.sizeCalculations = function () {
        ...
        HammerSwipe.prototype.findButtonBorder = function (direction) {
            Utils_1.Utils.removeClass(this.backElement[direction], "hidden");
            var borderEdge = 0;
            var backElement = this.backElement[direction];
            if (backElement && this.options.afterSwipeAction[direction] === "button") {
                var buttons = backElement.querySelectorAll("." + this.buttonClasses.join(", ."));
                for (var i = 0; i < buttons.length; i++) {
                    ...
                    var position = button.getBoundingClientRect().left;
                    if (direction === "left") {
        ...
        HammerSwipe.prototype.calculateThresholdAcceptSwipe = function (direction) {
            var thresholdAcceptSwipe = this.defaultThresholdAcceptSwipe;
        ...
        HammerSwipe.prototype.resetElements = function (animate) {
            if (animate === void 0) { animate = true; }
            Utils_1.Utils.removeClass(this.backElement.right, "hide");
            Utils_1.Utils.removeClass(this.backElement.left, "hide");
            Utils_1.Utils.removeClass(this.foreElement, "swiped-out");
            Utils_1.Utils.removeClass(this.container, "will-accept-swipe");
            Utils_1.Utils.addClass(this.afterElement.right, "hidden");
            Utils_1.Utils.addClass(this.afterElement.left, "hidden");
            this.show(0, animate);
        };
        HammerSwipe.prototype.show = function (percentage, animate) {
            if (percentage === void 0) { percentage = 0; }
            if (animate) {
                Utils_1.Utils.addClass(this.container, "animate");
            }
            else {
                Utils_1.Utils.removeClass(this.container, "animate");
            }
            var direction = percentage < 0 ? "left" : percentage > 0 ? "right" : undefined;
            if (direction && Math.abs(percentage) > this.thresholdAcceptSwipe[direction]) {
                Utils_1.Utils.addClass(this.container, "will-accept-swipe");
            }
            else {
                Utils_1.Utils.removeClass(this.container, "will-accept-swipe");
            }
            if (direction) {
                ...
                Utils_1.Utils.addClass(this.container, "swiping-" + direction);
                Utils_1.Utils.removeClass(this.container, "swiping-" + oppositeDirection);
            }
            else {
                Utils_1.Utils.removeClass(this.container, "swiping-right");
                Utils_1.Utils.removeClass(this.container, "swiping-left");
            }
            var position = (this.containerSize / 100) * percentage;
        ...
        HammerSwipe.prototype.updateBackground = function (direction) {
            if (this.backElement.right !== this.backElement.left) {
                var oppositeDirection = direction === "left" ? "right" : "left";
                Utils_1.Utils.addClass(this.backElement[oppositeDirection], "hidden");
            }
            Utils_1.Utils.removeClass(this.backElement[direction], "hidden");
        };
        HammerSwipe.prototype.swipeAnimation = function (direction) {
            Utils_1.Utils.addClass(this.container, "animate");
            var position = direction === "left" ? -this.containerSize : this.containerSize;
            if (this.options.afterSwipeAction[direction] === "button") {
        ...
        HammerSwipe.prototype.addRestoreEvent = function (element) {
            var _this = this;
            var restore = function (event) {
                if (!Utils_1.Utils.inElement(element, event.target, ["mx-button", "mx-link", "clickable"])) {
        ...
        HammerSwipe.prototype.afterSwipeAnimation = function (direction) {
            ...
            if (this.options.afterSwipeAction[direction] === "back") {
                ...
                if (this.afterElement.right !== this.afterElement.left) {
                    Utils_1.Utils.addClass(this.afterElement[oppositeDirection], "hidden");
                }
                Utils_1.Utils.removeClass(this.afterElement[direction], "hidden");
                setTimeout(function () {
                    Utils_1.Utils.addClass(_this.container, "animate");
                    domStyle.set(_this.container, { height: 0 });
                    setTimeout(function () {
                        Utils_1.Utils.addClass(_this.container, "hide");
                        Utils_1.Utils.removeClass(_this.container, "animate");
                        _this.options.callback(_this.container, direction);
                    }, _this.delayRemoveItem);
                }, this.options.callbackDelay[direction]);
            }
            else if (this.options.afterSwipeAction[direction] === "none") {
                Utils_1.Utils.addClass(this.foreElement, "swiped-out");
                setTimeout(function () {
                    _this.options.callback(_this.container, direction);
                }, this.options.callbackDelay[direction]);
            }
        ...
        HammerSwipe.prototype.addHideTransitionEvent = function (direction) {
            var _this = this;
            if (this.options.afterSwipeAction[direction] === "hide") {
                this.foreElement.addEventListener("transitionend", function () {
                    if (_this.isSwiped) {
                        domStyle.set(_this.container, {
                            height: _this.container.offsetHeight + "px"
                        });
                        Utils_1.Utils.addClass(_this.backElement[direction], "hide");
                    }
                });
            }
        };
    ...
    exports.HammerSwipe = HammerSwipe;
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! dojo/_base/declare */ "dojo/_base/declare"), __webpack_require__(/*! mxui/widget/_WidgetBase */ "mxui/widget/_WidgetBase"), __webpack_require__(/*! dijit/registry */ "dijit/registry"), __webpack_require__(/*! dojo/aspect */ "dojo/aspect"), __webpack_require__(/*! dojo/dom-class */ "dojo/dom-class"), __webpack_require__(/*! dojo/dom-construct */ "dojo/dom-construct"), __webpack_require__(/*! hammerjs */ "./node_modules/hammerjs/hammer.js"), __webpack_require__(/*! ./HammerSwipe */ "./src/HammerSwipe.ts"), __webpack_require__(/*! ./ui/ListViewSwipe.css */ "./src/ui/ListViewSwipe.css")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, dojoDeclare, WidgetBase, registry, dojoAspect, domClass, domConstruct, Hammer, HammerSwipe_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var ListViewSwipe = (function (_super) {
        __extends(ListViewSwipe, _super);
        function ListViewSwipe() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        ListViewSwipe.prototype.postCreate = function () {
            this.hammers = [];
        ...
        ListViewSwipe.prototype.update = function (_contextObject, callback) {
            var _this = this;
            if (this.targetWidget) {
                ...
                if (direction) {
                    var swipeOptions_1 = {
                        ...
                        callback: function (element, swipeDirection) { return _this.handleSwipe(element, swipeDirection); },
                    ...
                    dojoAspect.after(this.targetWidget, "_renderData", function () {
                        try {
                            var listItemsOffscreen = _this.targetNode.querySelectorAll(".mx-offscreen > li:not(.swipe-connected):not(.mx-listview-empty)");
                            Hammer.each(listItemsOffscreen, function (container) {
                                container.classList.add("swipe-connected");
                                _this.hammers.push(new HammerSwipe_1.HammerSwipe(container, swipeOptions_1));
                            }, _this);
                            var listItems = _this.targetNode.querySelectorAll("ul > li:not(.swipe-connected):not(.mx-listview-empty)");
                            Hammer.each(listItems, function (container) {
                                container.classList.add("swipe-connected");
                                _this.hammers.push(new HammerSwipe_1.HammerSwipe(container, swipeOptions_1));
                            }, _this);
                        }
                        catch (error) {
                            var codeException = !error.message.startsWith("LVS ");
                            var message = codeException ? error.message : error.message.substring(4);
                            _this.showError(message, codeException);
                        }
                    });
                }
            }
        ...
        ListViewSwipe.prototype.uninitialize = function () {
            this.hammers.forEach(function (hammer) { return hammer.destroy(); });
            return true;
        };
        ListViewSwipe.prototype.findTargetNode = function (name) {
            var queryNode = this.domNode.parentNode;
            var targetNode = null;
            while (!targetNode) {
                targetNode = queryNode.querySelector(".mx-name-" + name);
                if (window.document.isEqualNode(queryNode)) {
                    break;
                }
        ...
        ListViewSwipe.prototype.isDescendant = function (parent, child) {
        ...
        ListViewSwipe.prototype.validateConfig = function () {
            if (!this.targetNode) {
            ...
            var segments = this.targetWidget.datasource.path.split("/");
            var listEntity = segments.length ? segments[segments.length - 1] : "";
        ...
        ListViewSwipe.prototype.validateActionConfig = function (direction) {
        ...
        ListViewSwipe.prototype.showError = function (message, codeException) {
            if (codeException === void 0) { codeException = false; }
            var node = this.targetNode && this.targetNode.hasChildNodes() ? this.targetNode : this.domNode;
            var type = codeException ? "List view swipe code exception:" : "List view swipe configuration error:";
        ...
        ListViewSwipe.prototype.handleSwipe = function (element, direction) {
            var guid = registry.byNode(element).getGuid();
            var context = this.createContext(guid);
            this.handleAction(direction, context);
        };
        ListViewSwipe.prototype.handleAction = function (direction, context) {
            var _this = this;
            if (this.onSwipeAction[direction] === "callMicroflow" && this.onSwipeMicroflow[direction]) {
                window.mx.ui.action(this.onSwipeMicroflow[direction], {
                    context: context,
                    error: function (error) {
                        return window.mx.ui.error("An error occurred while executing microflow\n                    " + _this.onSwipeMicroflow[direction] + ": " + error.message, true);
                    }
                });
            }
                ...
                window.mx.data.callNanoflow({
                    ...
                    context: context,
                    error: function (error) {
                        return window.mx.ui.error("An error occurred while executing nanoflow\n                    " + _this.onSwipeNanoflow[direction] + ": " + error.message, true);
                    }
                });
            }
                ...
                window.mx.ui.openForm(this.onSwipePage[direction], {
                    ...
                    context: context,
                    error: function (error) {
                        return window.mx.ui.error("An error occurred while opening form\n                    " + _this.onSwipePage[direction] + " : " + error.message);
                    }
                });
            }
        };
        ListViewSwipe.prototype.createContext = function (guid) {
            var context = new mendix.lib.MxContext();
            context.setContext(this.itemEntity, guid);
            return context;
        };
        return ListViewSwipe;
    }(WidgetBase));
    dojoDeclare("ListViewSwipe.widget.ListViewSwipe", [WidgetBase], function (Source) {
        var result = {};
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports) {
    ...
    var Utils = (function () {
        ...
        Utils.inElement = function (elementContainer, element, classNames) {
            var hasClass = false;
            classNames.forEach(function (className) { return hasClass = hasClass || element.classList.contains(className); });
            if (hasClass) {
                return true;
            }
            else {
                if (elementContainer !== element) {
                    return this.inElement(elementContainer, element.parentNode, classNames);
                }
                else {
                    return false;
                }
        ...
        Utils.addClass = function (element, className) {
            ...
            for (var _i = 2; _i < arguments.length; _i++) {
                classNamesList[_i - 2] = arguments[_i];
            }
            classNamesList.push(className);
            if (element) {
                classNamesList.forEach(function (name) { return element.classList.add(name); });
            }
        };
...
module.exports = __WEBPACK_EXTERNAL_MODULE_dijit_registry__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE_dojo_base_declare__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE_dojo_aspect__;

/***/ }),

/***/ "dojo/dom-class":
/*!*********************************!*\
  !*** external "dojo/dom-class" ***!
  \*********************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = __WEBPACK_EXTERNAL_MODULE_dojo_dom_class__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE_dojo_dom_construct__;

/***/ }),

/***/ "dojo/dom-style":
/*!*********************************!*\
  !*** external "dojo/dom-style" ***!
  \*********************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = __WEBPACK_EXTERNAL_MODULE_dojo_dom_style__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE_mxui_widget_WidgetBase__;
